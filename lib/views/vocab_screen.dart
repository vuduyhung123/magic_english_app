                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => AddVocabScreen(
                      ...
                      onSave: (newItem) {
                        // Mapping dữ liệu từ AddScreen về Model
                        final newWord = VocabWord(
                          id: DateTime.now().millisecondsSinceEpoch,
                          word: newItem.word,
                          phonetic: newItem.phonetic, // Đảm bảo khớp tên thuộc tính
  ...
  Widget _buildWordCard(VocabWord word, BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.04), // Cú pháp mới
            blurRadius: 12,
              ...
              Row(
                children: [
                  ...
                  _buildActionButton(
                    ...
                    onTap: () => viewModel.deleteWord(word.id),
                  ),
                ],
              )
            ],
